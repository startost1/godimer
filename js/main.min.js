! function () {
	...
	if (e.length > 0)
		for (let i = 0; i < e.length; i++) {
			...
			a.classList.contains("tb") && t(a, l), s.addEventListener("click", function () {
...
function () {
	...
	function n(e, t) {
		...
		n.classList.remove("tb"), a.classList.remove("tb"), i ? (i.classList.add("tb"), l.classList.add("tb")) : "next" === t ? (e.firstElementChild.classList.add("tb"), e.parentNode.getElementsByClassName("ne")[0].firstElementChild.classList.add("tb")) : (e.lastElementChild.classList.add("tb"), e.parentNode.getElementsByClassName("ne")[0].lastElementChild.classList.add("tb"))
	}
	...
	if (t.length > 0)
		for (let a = 0; a < t.length; a++) {
			...
			u[r].classList.add("tb"), i(0, c), window.addEventListener("resize", function () {
				i(0, c)
			});
			let m = !1;
...
function () {
	...
	e && (e.addEventListener("click", function () {
		document.body.classList.toggle("tv"), t.classList.toggle("tb"), t.style.maxHeight ? t.style.maxHeight = null : t.style.maxHeight = t.scrollHeight + "px", "true" === this.getAttribute("aria-expanded") ? this.setAttribute("aria-expanded", "false") : this.setAttribute("aria-expanded", "true")
	...
	if (e.length > 0)
		for (let n = 0; n < e.length; n++) {
			...
			for (let e = 0; e < a.length; e++) {
				const t = a[e],
					n = {};
				n.currency = t.parentNode.querySelector(".iw"), n.amount = t.parentNode.querySelector(".pricing-item-price-amount"), n.after = t.parentNode.querySelector(".pricing-item-price-after"), n.data = JSON.parse(t.getAttribute("data-price-output")), l.push(n)
			}
